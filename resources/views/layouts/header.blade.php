...
@elseif(Auth::user()->user_type_id == 18 || Auth::user()->user_type_id == 21 || Auth::user()->user_type_id == 20)  {{--  if receptionist | accountant | doctor display branch --}}
<div class="card-header" style="background-color: #0d97c673;border-bottom: 1px solid #eaedf100;">
    <h3 class="card-title" style="font-size: 10px; margin:-15px; 
    color: #0d97c6;">BRANCH: {{ optional(Auth::user()->staff->branch)->branch_name ?? 'N/A' }}</h3>
</div>
@endif
        <!-- SEARCH -->
