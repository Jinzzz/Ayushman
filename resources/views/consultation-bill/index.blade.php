            ...
            <div class="col-md-4">
                ...
                <select class="form-control mt-2" name="patient_name" id="patient_name">
                    ...
                    @foreach($patientLists as $patientList)
                        <option value="{{ $patientList->patient_name }}" @if(request()->has('patient_name')) @if($patientList->patient_name== request('patient_name')) selected @endif  @endif>
