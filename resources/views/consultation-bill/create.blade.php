        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="col-lg-12" style="background-color: #fff;">
                    ...
                    @endif
                    <form action="{{ route('consultation-bill.store', ['id' => $invoice->id]) }}" id="addFm" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                        @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control paid-amount" name="discount" id="discount" placeholder="Discount Percentage" data-discount="{{ $discount }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control discountAmounts" id="amountDiscount" placeholder="Discount Amount">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control discountAmount" name="discountAmount" id="discountAmount" placeholder="Discount Percentage" data-discount="{{ $discount }}">
                    ...
                    <button type="button" class="btn btn-raised btn-primary" id="addRow" style="margin-left: 15px; " > Add New Row </button>
                        ...
                        <div class="form-group">
                            <center>
                                ...
                                <a class="btn btn-success" href="{{ route('consultation-bill.index') }}">Reset</a>
                             
                                <a class="btn btn-danger" href="{{ route('consultation-bill.index') }}">Cancel</a>
                            </center>
                        </div>
                        </div>
                    </form>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var discountInput = document.getElementById("discount");
    var totalAmountInput = document.getElementById("discountAmount");
    
    var errorMsg = document.getElementById("error-msg");
    var maxDiscount = parseFloat(discountInput.getAttribute("data-discount"));
    var totalDiscountAMount = document.getElementById("amountDiscount");
    ...
    function calculateTotalAmount() {
        ...
        if (isNaN(discount) || discount === 0) {
         totalAmountInput.value = paidAmount.toFixed(2);
            ...
            x = paidAmount * discount / 100;
            totalDiscountAMount.value = x
...
$(document).ready(function() {
        ...
        var originaldiscountAmount = $("#discountAmount").val();
        ...
        $("#no_bill").change(function() {
            if ($(this).is(":checked")) {
                ...
                $("#discountAmount").val(originaldiscountAmount);
