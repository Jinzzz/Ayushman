                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" required name="company_logo" value="{{ $settings->company_logo ?? '' }}" accept=".png, .jpeg, .jpg">
                                    <br>
                                    @isset($settings->company_logo)
                                    <div class="name">  
                                        <span><img style="height:50px; width:50px;" src="{{asset('assets/uploads/'.$settings->company_logo)}}" ></span>   
                                    </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="contact_number_1" value="{{ $settings->contact_number_1 ?? '' }}" placeholder="Primary Contact Number">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Secondary Contact Number*</label>
                                    <input type="text" class="form-control" required name="contact_number_2" value="{{ $settings->contact_number_2 ?? '' }}" placeholder="Secondary Contact Number">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
