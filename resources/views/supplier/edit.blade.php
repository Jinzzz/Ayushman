                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="business_name" value="{{$supplier->business_name}}" placeholder="Business Name">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" max="9999999999" min="1000000000" required name="phone_2" value="{{$supplier->phone_2}}" placeholder="Alternative Number">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="website" value="{{$supplier->website}}" placeholder="Website">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" required name="credit_period" value="{{$supplier->credit_period}}" placeholder="Credit Period">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Credit Limit</label>
                                    <input type="number" class="form-control" required name="credit_limit" value="{{$supplier->credit_limit}}" placeholder="Credit Limit">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" required name="opening_balance" value="{{$supplier->opening_balance}}" placeholder="Opening Balance">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" required name="account_ledger_id" value="{{$supplier->account_ledger_id}}" placeholder="Account Ledger">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Terms And Condition</label>
                                    <textarea class="form-control" required name="terms_and_conditions" placeholder="Terms And Condition">{{$supplier->terms_and_conditions}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" required name="opening_balance_date" value="{{$supplier->opening_balance_date}}" placeholder="Opening Balance Date">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
