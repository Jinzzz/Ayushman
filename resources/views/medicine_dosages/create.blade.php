                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input required type="text" class="form-control" name="medicine_dosages" value="{{ isset($medicine_dosages->name) ? $medicine_dosages->name : old('medicine_dosages') }}" placeholder="Medicine dosage">
                        </div>
                     </div>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <label class="custom-switch">
                              ...
                              <input type="checkbox" id="is_active" name="is_active" value="1" onchange="toggleStatus(this)" class="custom-switch-input" {{ isset($medicine_dosages->is_active) && $medicine_dosages->is_active == 1 ? 'checked' : '' }}>
                              <span id="statusLabel" class="custom-switch-indicator"></span>
                              <span id="statusText" class="custom-switch-description">
                                 {{ isset($medicine_dosages->is_active) && $medicine_dosages->is_active ? 'Active' : 'Inactive' }}
                              </span>
                           </label>
                        </div>
                     </div>
                  ...
                  <div class="form-group">
                     <center>
                        ...
                        <button type="reset" class="btn btn-raised btn-success">
                           Reset</button>
                        <a class="btn btn-danger" href="{{route('medicine.dosage.index')}}">Cancel</a>
                     </center>
                  </div>
            </div>
         </div>
