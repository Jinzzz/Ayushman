                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="offerPrice"  name="wellness_offer_price" value="{{ old('wellness_offer_price') }}" placeholder="Wellness Offer Price" oninput="validatePrices()">
