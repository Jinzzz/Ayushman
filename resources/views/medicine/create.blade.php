...
<div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="unit_price" value="{{ old('unit_price') }}" placeholder="Unit Price">
                                </div>
                            </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="reorder_limit" value="{{ old('reorder_limit') }}" placeholder="Reorder Limit" 
