...
@section('content')
    <div style="max-width: none; padding: 0;" class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="d-flex align-items-end">
                                        ...
                                        <a class="btn btn-primary" href="{{ route('attendance.view') }}"><i class="fa fa-times" aria-hidden="true"></i> Reset</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                @else
                    ...
                    @php
                        $leaveForDay = $staffLeaves->where('staff_id', $staff->staff_id)
                            ->where('from_date', '<=', $firstDayOfMonth->copy()->addDays($day - 1))
                            ->where('to_date', '>=', $firstDayOfMonth->copy()->addDays($day - 1))
                            ->first();
                    @endphp
