...
<head>
    ...
    <!-- TITLE -->
    <title>Ayushman Ayurveda -Doctor Login</title>
            ...
            <div class="">
                ...
                <div class="col col-login mx-auto">
                    <div class="text-center">
                        <img src="{{asset('assets/images/ayushman-logo.jpeg')}}" class="header-brand-img" alt="" width="100%">
                    </div>
                </div>
                <div class="container-login100">
                    <div class="wrap-login100 p-6">
                        ...
                        <form class="login100-form validate-form" method="post" action="{{route('doctor.login')}}">
                            {{ csrf_field() }}
                            <span class="login100-form-title">
                               Doctor Login
                            </span>
                            <div class="wrap-input100 validate-input">
                                <input class="input100" type="text" name="email" placeholder="Email" required value="{{old('email')}}">
