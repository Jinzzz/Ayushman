...
<head>
    ...
    <!-- TITLE -->
    <title>Ayushman Ayurveda - Receptionist Login</title>
                ...
                <div class="container-login100">
                    <div class="wrap-login100 p-6">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header-home home-login">{{ __('Receptionist Login') }}</div>
                                    ...
                                    <div class="card-home">
                                        ...
                                        <form class="login100-form login-form" method="POST"
                                            action="{{ route('receptionist.login.redirect') }}">
                                            @csrf
