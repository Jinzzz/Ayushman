        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="col-lg-12" style="background-color: #fff;">
                    ...
                    @endif
                    <form action="{{ route('therapy-bill.store', ['id' => $booking_id]) }}" id="addFm" method="POST"  onsubmit="return validateForm()" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control paid-amount" name="total-amount" id="amount" placeholder="Total Amount" readonly>
                        </div>
                    </div>
                </div>
                    ...
                    <button type="button" class="btn btn-raised btn-primary" id="addRow" style="margin-left: 15px; " > Add New Row </button>
                        ...
                        <div class="form-group">
                            <center>
                                ...
                                <a class="btn btn-success" href="{{ route('therapy-bill.index') }}">Reset</a>
                             
                                <a class="btn btn-danger" href="{{ route('therapy-bill.index') }}">Cancel</a>
                            </center>
                        </div>
                        </div>
                    </form>
