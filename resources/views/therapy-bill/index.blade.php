    ...
    <div class="col-md-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Therapy Billing</h3>
            </div>
            <form action="{{ route('therapy-bill.index') }}" method="GET">
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-4">
        ...
        <div class="col-md-4 d-flex align-items-center">
            <div>
                ...
                <a class="btn btn-secondary ml-2" href="{{ route('therapy-bill.index') }}"><i class="fa fa-times" aria-hidden="true"></i>Reset</a>
            </div>
        </div>
    </div>
</form>
                    ...
                    <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a class="btn btn-secondary" href="{{ route('therapy-bill.create', $patient->id) }}">
