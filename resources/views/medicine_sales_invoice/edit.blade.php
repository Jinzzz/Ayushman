                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="patient_booking_id" id="patient_booking_id">
                              ...
                              <!-- @foreach ($patient_booking_ids as $patient_booking_id)
                              <option value="{{ $patient_booking_id->id }}" {{ $patient_booking_id->id == $medicine_sale_invoices->booking_id ? ' selected' : '' }}>
                                 {{ $patient_booking_id->booking_reference_number }}
                              </option>
                              @endforeach -->
                           </select>
                        </div>
                                    ...
                                    <tr id="productRowTemplate">
                                       <td>
                                          <select class="form-control medicine-name" name="medicine_id[]" dis>
                                             ...
                                             <option value="{{ $medicine->id }}" {{ $medicine->id == $sale_details['medicine_id'] ? ' selected' : '' }}>{{ $medicine->medicine_name}}</option> @endforeach
                                          </select>
                                       </td>
                     ...
                     <div class="col-md-6">
                        ...
                        <div id="terms_condition" class="custom-margin">
                           ...
                           <div class="form-group">
                              ...
                              <textarea class="form-control" name="terms_condition" placeholder="Terms and Conditions">{{$medicine_sale_invoices->terms_and_conditions}}</textarea>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <select class="form-control" Disabled name="payment_mode" placeholder="Payment Mode" id="payment_mode" onchange="updateDepositTo()">
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              <label class="form-label" Disabled>Deposit To</label>
                              <select class="form-control" name="deposit_to" id="deposit_to">
                                 <option value="">{{$deposit_to}}</option>
                              </select>
                           </div>
                        </div>
                     </div>
