         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <form action="{{ route('medicine.sales.return.update') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                              ...
                              <table class="table card-table table-vcenter text-nowrap" id="productTable">
                                 ...
                                 @foreach ($medicine_sale_details as $sale_details)
                                    <tr id="productRowTemplate">
                                       ...
                                       <td class="medicine-mfd"><input type="hidden" value="{{$sale_details->quantity_unit_id}}" class="form-control" name="mfd[]" readonly></td>
                                       <td class="medicine-expd"><input type="hidden" value="{{$sale_details->quantity_unit_id}}" class="form-control" name="expd[]" readonly></td>
                                    </tr>
                                    @endforeach
                                 </tbody>
                              </table>
                  ...
                  <div class="modal" id="medicineBatchModal" tabindex="-1" role="dialog" aria-labelledby="medicineBatchModalLabel" aria-hidden="true">
