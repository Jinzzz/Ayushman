            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input type="date" class="form-control" name="patient_dob" value="{{$patient->patient_dob}}" id="patient_dob">
                  </div>
               </div>
               <div class="col-sm-6">
                  <div class="form-group">
               ...
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="emergency_contact_person" name="emergency_contact_person" maxlength="100" value="{{$patient->emergency_contact_person}}" >
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="emergency_contact" name="emergency_contact" value="{{$patient->emergency_contact}}"  maxlength="10" oninput="validateInput(this)">
                     <p class="error-message" style="color: red; display: none;">Only numbers are allowed.</p>
                  </div>
               </div>
               <div class="col-md-6">
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <textarea class="form-control" name="patient_medical_history" id="medicalHistory">{{$patient->patient_medical_history}}</textarea>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="form-group">
                     <label class="form-label">Patient Current Medication</label>
                     <textarea class="form-control" name="patient_current_medications" id="currentMedication">{{ $patient->patient_current_medications }}</textarea>
                  </div>
               </div>
            </div>
               ...
               <div class="col-md-12">
                  ...
                  <div class="form-group">
                     ...
                     <label class="custom-switch">
                     <input type="checkbox" id="has_credit" name="has_credit" onchange="toggleStatus1(this)" class="custom-switch-input" @if($patient->has_credit) checked @endif>
                     <span id="statusLabel1" class="custom-switch-indicator"></span>
                     <span id="statusText1" class="custom-switch-description">
                     @if($patient->has_credit)
                     Active
                     @else
                     Inactive
                     @endif
   ...
   function toggleStatus(checkbox) {
      ...
      function toggleStatus1(checkbox) {
       if (checkbox.checked) {
           ...
           $("input[name=has_credit]").val(1); // Set the value to 1 when checked
       } else {
           $("#statusText1").text('Inactive');
           $("input[name=has_credit]").val(0); // Set the value to 0 when unchecked
       }
   }
</script>
<script>
