                ...
                <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr id="dataRow_{{$patient->id }}">
                            ...
                            <td>
                                <a class="btn btn-sm  btn-outline-success " href="{{ route('patients.membership', $patient->id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Membership Packages</a>
                            </td>
                            <td>
                            ...
                            <td>
                                <button type="button" style="width: 70px;" onclick="changeStatus({{ $patient->id}})" class="btn btn-sm @if($patient->is_active == 0) btn-danger @else btn-success @endif">
