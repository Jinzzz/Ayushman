                        ...
                        <tbody>
                            ...
                            <tr id="dataRow_{{ $branch->branch_id }}">
                                ...
                                <td>
                                    ...
                                    <button type="button" style="width: 70px;" onclick="changeStatus({{ $branch->branch_id }})" class="btn btn-sm @if($branch->is_active == 0) btn-danger @else btn-success @endif">
                                ...
                                <td>
                                    <a class="btn btn-primary btn-sm edit-custom" href="{{ route('branches.edit', $branch->branch_id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit </a>
                                    <a class="btn btn-secondary btn-sm" href="{{ route('branches.show',$branch->branch_id) }}">
                                        <i class="fa fa-eye" aria-hidden="true"></i> View </a>
                                    <form style="display: inline-block" action="{{ route('branches.destroy', $branch->branch_id) }}" method="post">
                                        @csrf
                                        @method('delete')
