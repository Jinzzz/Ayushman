      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="col-lg-12" style="background-color:#fff" ;>
               ...
               @endif
               <form action="{{route('branches.update',['branch_id'=>$branch->branch_id])}}" id="addFm" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <div class="row">
                     <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" required name="latitude" value="{{ $branch->latitude }}" placeholder="Latitude" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '');" pattern="[0-9]+(\.[0-9]+)?">
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           <label class="form-label">Longitude*</label>
                           <input type="text" class="form-control" required name="longitude" value="{{ $branch->longitude }}" placeholder="Longitude" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '');" pattern="[0-9]+(\.[0-9]+)?">
                        </div>
                     </div>
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                           <center>
                              <button type="submit" id="submitForm" class="btn btn-raised btn-info">Update</button>
