      ...
      <div class="col-md-12">
         <div class="card">
            <div class="card-header">
               <h3 class="mb-0 card-title">Add Staff Specialization</h3>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-control" name="staff_id" id="staff_id">
                ...
                <option value="{{ $id }}"{{ old('staff_id') == $id ? 'selected' : '' }}>{{ $staffName }}</option>
                @endforeach
            </select>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-control" name="specialization" id="specialization">
                ...
                <option value="{{ $masterId }}"{{ old('specialization') == $masterId ? 'selected' : '' }}>{{ $masterValue }}</option>
                @endforeach
            </select>
        </div>
    </div>
