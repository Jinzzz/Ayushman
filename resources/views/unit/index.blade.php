...
<div class="row">
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('unit.create') }}" class="btn btn-block btn-info">
                ...
                <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr id="dataRow_{{ $unit->id }}">
                            ...
                            <td>
                                <a class="btn btn-secondary" href="{{ route('unit.edit', $unit->id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit </a>
                                <button type="button" onclick="deleteData({{ $unit->id }})" class="btn btn-danger">
    ...
    function changeStatus(dataId) {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: "{{ route('unit.changeStatus', '') }}/" + dataId,
                        type: "patch",
                        data: {
                            _token: "{{ csrf_token() }}",
                        },
