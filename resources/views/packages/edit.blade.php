            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="package_amount_value" id="package_amount_value" pattern="[0-9]*" oninput="this.value = this.value.replace(/[^0-9]/g, '')" value="{{ $packages->package_amount_value }}" placeholder="Package Amount Value">
                </div>
              </div>
            </div>
            <div class="row">
