    ...
    <div class="col-md-12"> 
      <div class="card"> 
        ...
        <div class="col-lg-12" style="background-color: #fff;"> 
          ...
          @endif 
          <form action="{{ route('packages.store') }}" id="addFm" method="POST" enctype="multipart/form-data"> 
            @csrf 
            <div class="row"> 
              <div class="col-md-6"> 
            ...
            <div class="form-group"> 
              <center> 
                <button type="submit" id="submitForm" class="btn btn-raised btn-primary"> 
                  ...
                  <a class="btn btn-success" href="{{ route('packages.create') }}">Reset</a>
  ...
  $(document).ready(function () { 
    validator = $("#addFm").validate({ 
      ...
      messages: { 
        ...
        package_amount_value: "Please enter package amount value.", 
