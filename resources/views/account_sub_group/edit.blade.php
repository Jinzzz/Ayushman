        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="addFm" action="{{ route('account.sub.group.update',['id'=>$account_sub_groups->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select required class="form-control" name="account_group_id" id="account_group_id">
                                        ...
                                        <option value="{{ $account_group->id }}" {{ $account_group->id == $account_sub_groups->account_group_id ? ' selected' : '' }}>{{ $account_group->account_group_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="sub_group_name" value="{{ $account_sub_groups->account_sub_group_name }}" placeholder="Sub Group Name">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label class="custom-switch">
                                    ...
                                    <input type="checkbox" id="is_active" name="is_active" onchange="toggleStatus(this)" class="custom-switch-input" @if($account_sub_groups->is_active) checked @endif value="1">
                                    <span id="statusLabel" class="custom-switch-indicator"></span>
                                    <span id="statusText" class="custom-switch-description">
                                        @if($account_sub_groups->is_active)
                                        Active
                                        @else
                                        Inactive
                                        @endif
