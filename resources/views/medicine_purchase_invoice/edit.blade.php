            ...
            <div class="card-body">
               ...
               <form action="{{ route('excel.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <form action="{{ route('medicinePurchaseInvoice.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  {{-- @php
                  print_r($medicinePurchaseInvoice);
                  @endphp --}}
                  <div class="row">
                     <div class="col-md-3">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="supplier_id" id="supplier_id"  required onchange="emptyOthers()">
                              ...
                              <option value="{{ $supplier->supplier_id }}"{{ $supplier->supplier_id == $medicinePurchaseInvoice->branch_id ? 'selected' : '' }} data-extra-value="{{ $supplier->credit_period }}">
                     ...
                     <div class="col-md-2">
                        <div class="form-group">
                           ...
                           value="{{ $medicinePurchaseInvoice->purchase_invoice_no}}" placeholder="Invoice No">
                        </div>
                     </div>
                     <div class="col-md-2">
                        <div class="form-group">
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="branch_id" id="branch_id" required>
                              ...
                              <option value="{{ $id }}" {{ $id == $medicinePurchaseInvoice->branch_id ? 'selected' : '' }}>{{ $branchName }}</option>
                              @endforeach
                           </select>
                        </div>
                     </div>
                              ...
                              <table class="table card-table table-vcenter text-nowrap" id="productTable">
                                 ...
                                 <tbody>
                                    ...
                                    <tr id="productRowTemplate">
                                       ...
                                       <td><input type="text" class="form-control" name="medicine_code[]" value="{{ $detail->medicine_code }}"></td>
                                       <td><input type="number" class="form-control" name="quantity[]" value="{{ $detail->quantity }}"></td>
                                       <td><input type="text" class="form-control" readonly name="unit_id[]" value="{{ $detail->unit_id }}"></td>
                                       <td><input type="text" class="form-control" name="rate[]" value="{{ $detail->rate }}"></td>
                                       <td><input type="text" class="form-control" name="discount[]" value="{{ $detail->discount }}"></td>
                                       <td><input type="text" class="form-control" name="free_quantity[]" value="{{ $detail->free_quantity }}"></td>
                                       <td><input type="text" class="form-control" name="batch_no[]" value="{{ $detail->batch_no }}"></td>
                                       <td>
                                          <input type="date" class="form-control date-picker" name="mfd[]" value="{{ $detail->mfd }}">
                                       </td>
                                       <td>
                                          <input type="date" class="form-control date-picker" name="expd[]" value="{{ $detail->expd }}">
                                       </td>
                                       <td><input type="text" class="form-control" readonly name="tax[]"  value="{{ $detail->tax_amount }}"></td>
                                       <td><input type="text" class="form-control" name="amount[]" value="{{ $detail->amount }}"></td>
                                       <td>
                                          {{-- condition checking --}}
                                          @php
