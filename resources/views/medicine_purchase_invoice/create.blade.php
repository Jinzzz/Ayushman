               ...
               <form action="{{ route('excel.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <form action="{{ route('medicinePurchaseInvoice.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                  ...
                  <div class="row">
                     <div class="col-md-3">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="supplier_id" id="supplier_id"  required onchange="updateCreditLimit();">
                     ...
                     <div class="col-md-2">
                        <div class="form-group">
                           ...
                           <input type="date" class="form-control" required name="invoice_date"  id="invoice_date" onchange="updateDueDate()" 
                              maxlength="16" value="{{ old('invoice_date') }}" placeholder="Invoice Date" >
                        </div>
                     </div>
                     <div class="col-md-3">
                        <div class="form-group">
                  ...
                  <div class="row" style="align-items:center">
                     <div class="col-6">
                        <p><span><strong>Credit Limit:</strong></span><span id="creditLimitDisplay" name="credit_limit"
                           style="color: green;"></span></p>
                        <p><span><strong>Current Credit:</strong></span> <span id="" name="current_credit"
                 ...
                 <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" readonly name="igst" 
                        id="igst" placeholder="IGST">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
