    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            ...
            <div class="card displaycard ShowFilterBox">
                ...
                <form action="{{ route('purchase.return.report.detail', ['id' => $return_id]) }}" method="GET" class="card-body">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <center>
                                        ...
                                        <a class="btn btn-primary"
                                            href="{{ route('purchase.return.report.detail', ['id' => $return_id]) }}"><i
            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-md-6">
                    <h3 class="card-title">Purchase Return Report Detail</h3>
                    </div>
                    <div class="col-md-6 d-flex justify-content-end">
                        <a class="btn btn-raised btn-primary" href="{{route('purchase.return.report')}}">BACK</a>
                     </div>
                </div>
                <div class="card-body">
                        ...
                        <table id="report" class="table table-striped table-bordered text-nowrap w-100">
                            ...
                            <tbody>
                                ...
                                @foreach ($purchase_return_details as $key => $purchase_return_detail)
                                    <tr id="dataRow_{{ $purchase_return_detail->id   }}">
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ @$purchase_return_detail->returnInvoice['purchase_return_no'] }}</td>
                                        <td>{{ @$purchase_return_detail->Medicine['medicine_name'] }}</td>
                                        <td>{{ @$purchase_return_detail->Unit['unit_name'] }}</td>
                                        <td>{{ $purchase_return_detail->return_quantity }}
                                        </td>
                                        <td>{{ $purchase_return_detail->rate }}</td>
                                        <td>{{ $purchase_return_detail->return_rate }}</td> 
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
            ...
            $(document).ready(function() {
                ...
                $('#report').DataTable({
                    ...
                    buttons: [{
                            ...
                            title: 'Purchase Return Report Detailed',
                            exportOptions: {
